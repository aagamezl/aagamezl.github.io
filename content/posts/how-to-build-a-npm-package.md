...
* <a href="https://istanbul.js.org/" target="_blank">Istanbul</a>: Istanbul is a test coverage tool that works with many different frameworks. It tracks which parts of your code are executed by your unit tests.
...
This config is for Node.js v16.11.0 and NPM 8.0.0 or higher.

## Git Repository

To manage and publish the code of our package we will use <a href="https://github.com/" target="_blank">GitHub</a>, so we must create a repository of type Node.js and later we clone it in our development environment.
